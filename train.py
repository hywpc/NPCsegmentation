...
# train_set = NPCDataSet('', scatter_label=False, transform=False, crop=True, crop_size=(80, 160, 160), mode='train')
train_loader = DataLoader(data_set, batch_size=1, shuffle=True, num_workers=0, pin_memory=True)
...
# val_set = NPCDataSet('', scatter_label=True, transform=False, crop=False, crop_size=(80, 160, 160), mode='test')
